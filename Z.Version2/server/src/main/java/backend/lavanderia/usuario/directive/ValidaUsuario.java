...
public class ValidaUsuario
{
	...
	public static void usuario(FuncionarioDTO funcionario) throws RuntimeException
	{
		...
		funcionario.setDataNascimento(validaData(funcionario.getDataNascimento()));
	...
	private static String validaData(String data) throws RuntimeException
	{
		char[] auxData = data.toCharArray();
		char[] returnData = data.toCharArray();
